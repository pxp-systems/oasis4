...
case class CreditorClaimSearchResult (
  ...
  claimRegistrationType: Option[CreditorClaimSearchResultEnums.ClaimRegistrationType],
  /* The type of claim  */
  claimType: Option[CreditorClaimSearchResultEnums.ClaimType],
  ...
  claimStatus: Option[CreditorClaimSearchResultEnums.ClaimStatus],
  links: Option[Link],
  /* The array of related claims */
  relatedClaims: Option[Seq[CreditorClaimSearchResultBase]]
) extends ApiModel

object CreditorClaimSearchResultEnums {
