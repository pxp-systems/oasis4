...
case class OrganisationSearchResults (
  ...
  sortOrder: Option[OrganisationSearchResultsEnums.SortOrder],
  ...
  items: Option[Seq[OrganisationSearchResult]]
) extends ApiModel

object OrganisationSearchResultsEnums {
