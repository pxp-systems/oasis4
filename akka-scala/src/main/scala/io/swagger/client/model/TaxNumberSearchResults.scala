...
case class TaxNumberSearchResults (
  ...
  sortOrder: Option[TaxNumberSearchResultsEnums.SortOrder],
  ...
  items: Option[Seq[TaxNumberSearchResult]]
) extends ApiModel

object TaxNumberSearchResultsEnums {
