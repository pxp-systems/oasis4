...
case class SubmitClaimRegistrationRecord (
  ...
  appEvidenceCode: Option[SubmitClaimRegistrationRecordEnums.AppEvidenceCode],
  /*  */
  ...
  /* Enum:   */
  wagesEvidenceCode: Option[SubmitClaimRegistrationRecordEnums.WagesEvidenceCode],
...
object SubmitClaimRegistrationRecordEnums {
