...
case class ContactSearchResults (
  ...
  sortOrder: Option[ContactSearchResultsEnums.SortOrder],
  ...
  searchResults: Option[Seq[ContactSearchResult]]
) extends ApiModel

object ContactSearchResultsEnums {
