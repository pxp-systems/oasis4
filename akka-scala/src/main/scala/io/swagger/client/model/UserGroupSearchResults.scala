...
case class UserGroupSearchResults (
  ...
  sortOrder: Option[UserGroupSearchResultsEnums.SortOrder],
  ...
  items: Option[Seq[UserGroupSearchResult]]
) extends ApiModel

object UserGroupSearchResultsEnums {
