...
case class CreditorClaimSearchResults (
  ...
  sortOrder: Option[CreditorClaimSearchResultsEnums.SortOrder],
  ...
  items: Option[Seq[CreditorClaimSearchResult]]
) extends ApiModel

object CreditorClaimSearchResultsEnums {
