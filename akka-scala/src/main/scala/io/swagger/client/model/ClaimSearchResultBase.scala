...
case class ClaimSearchResultBase (
  ...
  claimRegistrationType: Option[ClaimSearchResultBaseEnums.ClaimRegistrationType],
  /* The type of claim  */
  claimType: Option[ClaimSearchResultBaseEnums.ClaimType],
  ...
  status: Option[ClaimSearchResultBaseEnums.Status],
  links: Option[Link]
) extends ApiModel

object ClaimSearchResultBaseEnums {
