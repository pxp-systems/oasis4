...
case class DataProtectionRuleSearchResults (
  ...
  sortOrder: Option[DataProtectionRuleSearchResultsEnums.SortOrder],
  ...
  items: Option[Seq[DataProtectionRuleSearchResult]]
) extends ApiModel

object DataProtectionRuleSearchResultsEnums {
