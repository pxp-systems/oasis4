...
case class EvidenceSearchResults (
  ...
  sortOrder: Option[EvidenceSearchResultsEnums.SortOrder],
  ...
  items: Option[Seq[EvidenceSearchResult]]
) extends ApiModel

object EvidenceSearchResultsEnums {
