...
case class AddressSearchResults (
  ...
  sortOrder: Option[AddressSearchResultsEnums.SortOrder],
  ...
  items: Option[Seq[AddressSearchResult]]
) extends ApiModel

object AddressSearchResultsEnums {
