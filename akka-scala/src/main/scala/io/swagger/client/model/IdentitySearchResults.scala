...
case class IdentitySearchResults (
  ...
  sortOrder: Option[IdentitySearchResultsEnums.SortOrder],
  ...
  items: Option[Seq[IdentitySearchResult]]
) extends ApiModel

object IdentitySearchResultsEnums {
