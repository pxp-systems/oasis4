...
case class ClaimRegistrationSearchResults (
  ...
  sortOrder: Option[ClaimRegistrationSearchResultsEnums.SortOrder],
  ...
  items: Option[Seq[ClaimRegistrationSearchResult]]
) extends ApiModel

object ClaimRegistrationSearchResultsEnums {
